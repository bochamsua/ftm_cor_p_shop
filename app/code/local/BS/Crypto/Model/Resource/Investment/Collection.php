 ...
 */
/**
 * Investment collection resource model
 *
 * @category    BS
 * @package     BS_Crypto
 * @author Bui Phong
 */
class BS_Crypto_Model_Resource_Investment_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
