 ...
 */
/**
 * Investment Period resource model
 *
 * @category    BS
 * @package     BS_Crypto
 * @author Bui Phong
 */
class BS_Crypto_Model_Resource_Period extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('bs_crypto/period', 'entity_id');
    }
